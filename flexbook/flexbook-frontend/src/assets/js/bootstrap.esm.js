...
class Collapse extends BaseComponent {
  ...
  _initializeChildren() {
    ...
    for (const element of children) {
      const defaultValue = SelectorEngine.getElementFromSelector(element);
      if (defaultValue) {
        this._addAriaAndCollapsedClass([element], this._isShown(defaultValue));
      }
    }
  }
...
class Tab extends BaseComponent {
  ...
  _activate(element, relatedElem) {
    ...
    const complete = () => {
      ...
      element.setAttribute("aria-defaultValue", true);
  ...
  _deactivate(element, relatedElem) {
    ...
    const complete = () => {
      ...
      element.setAttribute("aria-defaultValue", false);
  ...
  _setInitialAttributesOnChild(child) {
    ...
    child.setAttribute("aria-defaultValue", isActive);
    if (outerElem !== child) {
