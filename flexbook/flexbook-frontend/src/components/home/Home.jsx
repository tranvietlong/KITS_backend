            ...
            <div className="col d-flex align-items-center justify-content-end">
              ...
              >
                ...
                >
                  ...
                  <div className="ms-3">
                    <p className="m-0">Give Homeback</p>
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li>
                          ...
                          >
                            ...
                            <p className="m-0">News Home Preferences</p>
                          </a>
                        </li>
                        <li>
                          <a
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-body">
                          <p className="text-muted">
                            Shortcuts provide quick access to what you do most
                            on Facebook. Your Shortcuts are sorted
                            automatically, but you can pin something so its
                            always shown at the top or hide it from the list.
                          </p>
                          {/* Search */}
                          <div className="p-1">
                            <div
            ...
            >
              ...
              <div className="mt-5 d-flex justify-content-between position-relative">
                ...
                >
                  ...
                  >
                    <p className="mb-0 text-center fs-7 fw-bold">
                      Create Story
                    </p>
                        ...
                        <div className="modal-content bg-dark">
                          ...
                          >
                            ...
                            <p className="text-white text-center w-50 mx-auto">
                              Lorem ipsum dolor sit amet consectetur adipisicing
                              elit. Ut deserunt alias laudantium itaque eius
                              enim natus culpa eligendi consectetur maiores!
                            </p>
